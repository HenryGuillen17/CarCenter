...
CREATE TABLE mecanicos (
    tipo_documento     VARCHAR(2) NOT NULL,
    documento          INTEGER
        CONSTRAINT nnc_clientev1_cedula NOT NULL,
    primer_nombre      VARCHAR(30) NOT NULL,
    segundo_nombre     VARCHAR(30),
    primer_apellido    VARCHAR(30) NOT NULL,
    segundo_apellido   VARCHAR(30),
...
CREATE TABLE servicios (
    codigo            INTEGER
        CONSTRAINT nnc_servicio_idservicio NOT NULL,
    nombre_servicio   VARCHAR(100) NOT NULL,
    precio            numeric(18,0)
        CONSTRAINT nnc_servicio_precio NOT NULL
);
...
---//////////////
    ...
    @name = N'MS_Description', @value = '1. Cedula de ciudadanía - CC 2. Cedula de extrangería - CE 3. Tarjeta de identidad - TI', 
    @level0type = N'Schema', @level0name = 'dbo', 
    @level1type = N'Table', @level1name = 'clientes', 
    @level2type = N'Column', @level2name = 'tipo_documento' 


	EXEC sp_addextendedproperty 
    @name = N'MS_Description', @value = '1. Citado 2. Cotizado 3. Ejecutandose 4. Liquidado 5. Facturado', 
    @level0type = N'Schema', @level0name = 'dbo', 
    @level1type = N'Table', @level1name = 'mantenimientos', 
	...
	EXEC sp_addextendedproperty 
    @name = N'MS_Description', @value =  '0. Libre 1. Ocupado', 
    @level0type = N'Schema', @level0name = 'dbo', 
    @level1type = N'Table', @level1name = 'mecanicos', 
    @level2type = N'Column', @level2name = 'estado' 

	EXEC sp_addextendedproperty 
    @name = N'MS_Description', @value =   'En horas', 
    @level0type = N'Schema', @level0name = 'dbo', 
    @level1type = N'Table', @level1name = 'repuestos_x_mantenimientos', 
    @level2type = N'Column', @level2name = 'tiempo_estimado' 

	EXEC sp_addextendedproperty 
    @name = N'MS_Description', @value =   'En horas', 
    @level0type = N'Schema', @level0name = 'dbo', 
    @level1type = N'Table', @level1name = 'servicios_x_mantenimientos', 
    @level2type = N'Column', @level2name = 'tiempo_estimado' 
